...
public class TransferService {
        ...
        public Map<String, Object> transfer(TransferRequest request) throws Exception {
                ...
                notificationService.notifyTransferSent(sender, recipient.getName(), request.getAmount(),
                                senderWallet.getCurrency());
                notificationService.notifyTransferReceived(recipient, sender.getName(), convertedAmount,
                                recipientWallet.getCurrency());
        ...
        public Map<String, Object> convertCurrency(ConvertCurrencyRequest request) throws Exception {
                ...
                return Map.of(
                                ...
                                "exchangeRate",
                                currencyService.getExchangeRate(fromWallet.getCurrency(), toWallet.getCurrency()),
